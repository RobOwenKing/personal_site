...
const capitalsES = [
  ...
  { prompt: 'the Community of Madrid (Comunidad de Madrid)', answers:['madrid'] },
  { prompt: 'the Valencian Community (Comunitat Valenciana)', answers:['valencia'] },
  { prompt: 'Galicia', answers:['santiago de compostela'] },
  { prompt: 'Castile and León (Castilla y León)', answers:['valladolid'], category: 'de facto capital' },
  { prompt: 'the Basque Country (Euskadi / País Vasco)', answers:['vitoria-gasteiz', 'vitoria', 'gasteiz'], category: 'de facto capital' },
  { prompt: 'Castilla-La Mancha', answers:['toledo'], category: 'de facto capital' },
  { prompt: 'the Canary Islands (Canarias)', answers:['las palmas de gran canaria', 'las palmas'], category: 'joint capital (with Santa Cruz de Tenerife)' },
  { prompt: 'the Canary Islands (Canarias)', answers:['santa cruz de tenerife', 'santa cruz'], category: 'joint capital (with Las Palmas de Gran Canaria)' },
  { prompt: 'the Region of Murcia (Región de Murcia)', answers:['murcia'] },
  { prompt: 'Aragon (Aragón)', answers:['zaragoza'] },
  { prompt: 'Extremadura', answers:['mérida', 'merida'] },
  { prompt: 'the Balearic Islands (Islas Baleares)', answers:['palma'] },
  { prompt: 'the Principality of Asturias (Principado de Asturias)', answers:['oviedo'] },
  { prompt: 'the Chartered Community of Navarre (Comunidad Foral de Navarra)', answers:['pamplona'] },
